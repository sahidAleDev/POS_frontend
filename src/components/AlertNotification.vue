...
<template>
  <Transition name="fade">
    <div v-if="$notificationStore.isVisible" id="toast-top-right" class="fixed flex justify-between items-center w-full z-50 max-w-xs p-4 space-x-4 text-gray-500 bg-white border border-slate-100  rtl:divide-x-reverse divide-gray-200 rounded-lg shadow-sm top-5 right-5 dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800" role="alert">
      <component 
